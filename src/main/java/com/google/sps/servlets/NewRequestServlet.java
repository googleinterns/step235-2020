...
public class NewRequestServlet extends HttpServlet {
  ...
  private void processDeliveryRequest(DeliverySlot deliverySlot, int maxStops, String userId, Double startLat, Double startLng) {
    ...
    DeliverySystem deliverySystem = new DeliverySystem(new GoogleMapsPathFinder());
    Journey journey = deliverySystem.findOptimalDeliveryJourneyForRequest(
        deliverySlot, maxStops, userId, startLat, startLng);
